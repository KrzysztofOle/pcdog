...
class NetworkAgentTests(unittest.TestCase):
    ...
    def test_systemd_integration_is_isolated_from_power_agent(self) -> None:
        ...
        launcher = (root / "runtime/pcdog-network-agent.sh").read_text(encoding="utf-8")
        ...
        self.assertIn("from pcdog_runtime.network_agent import main; main()", launcher)
        self.assertNotIn("-m pcdog_runtime.network_agent", launcher)
